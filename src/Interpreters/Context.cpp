...
void Context::initializeBackupsWorker()
{
    ...
    {
        .num_backup_threads = config.getUInt64("backup_threads", settings.backup_threads),
        .num_restore_threads = config.getUInt64("restore_threads", settings.restore_threads),
