...
QueryCache::Writer QueryCache::createWriter(const Key & key, std::chrono::milliseconds min_query_runtime, bool squash_partial_results, size_t max_block_size, size_t max_query_cache_size_quota, size_t max_query_cache_entries_quota)
{
    ...
    /// users.xml change.
    cache.setQuotaForUser(key.user_name, ICachePolicyUserQuota::Resource::Size, max_query_cache_size_quota);
    cache.setQuotaForUser(key.user_name, ICachePolicyUserQuota::Resource::Items, max_query_cache_entries_quota);
