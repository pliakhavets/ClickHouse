...
StreamInQueryCacheTransform::StreamInQueryCacheTransform(
    ...
    size_t max_query_cache_size_quota, size_t max_query_cache_entries_quota)
    : ISimpleTransform(header_, header_, false)
    , cache_writer(cache->createWriter(cache_key, min_query_duration, squash_partial_results, max_block_size, max_query_cache_size_quota, max_query_cache_entries_quota))
{
}
