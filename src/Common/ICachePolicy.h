...
public:
    ...
    virtual void setQuotaForUser(const String & user_name, ICachePolicyUserQuota::Resource resource, size_t quota, std::lock_guard<std::mutex> & /*cache_lock*/) { user_quotas->setQuotaForUser(user_name, resource, quota); }
