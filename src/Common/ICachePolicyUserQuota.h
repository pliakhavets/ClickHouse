...
public:
    ...
    virtual void setQuotaForUser(const String & user_name, Resource resource, size_t quota_in_bytes) = 0;

    /// Update the actual resource usage for the given user.
    virtual void increaseActual(const String & user_name, Resource resource, size_t entry_size_in_bytes) = 0;
    virtual void decreaseActual(const String & user_name, Resource resource, size_t entry_size_in_bytes) = 0;
...
{
public:
    void setQuotaForUser(const String & /*user_name*/, Resource /*resource*/, size_t /*entry_size_in_bytes*/) override {}
    void increaseActual(const String & /*user_name*/, Resource /*resource*/, size_t /*entry_size_in_bytes*/) override {}
    void decreaseActual(const String & /*user_name*/, Resource /*resource*/, size_t /*entry_size_in_bytes*/) override {}
